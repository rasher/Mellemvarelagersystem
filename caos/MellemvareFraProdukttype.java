...
public class MellemvareFraProdukttype
{
	public static void main(String[] args)
	{
		try 
		{
			...
			ResultSet res=stmt.executeQuery("Select produkttype.NAVN from Produkttype");
			while (res.next()) {
				System.out.println("Produkttype: " + res.getString(1));
			}
			System.out.println("Indtast produkttype navn: ");
			...
			res=stmt.executeQuery("SELECT m.BATCHNUMMER, d.NAVN, bt.RÆKKEFØLGE, (SELECT COUNT(*) FROM " +
